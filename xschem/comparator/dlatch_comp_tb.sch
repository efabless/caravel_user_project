...
N 720 -80 900 -80 { lab=o2}
N 900 -100 900 -80 { lab=o2}
...
.save all
"}
C {devices/vsource.sym} 60 -270 0 0 {name=V6 value=PULSE(0,1,0,1n,1n,75n,150n)}
C {devices/vsource.sym} 280 -270 0 0 {name=V7 value=PULSE(0,1,0,1n,1n,75n,150n,180)}
C {devices/vsource.sym} 60 -170 0 0 {name=V8 value=sin(0.6,0.1,50000)}
C {devices/vsource.sym} 60 -70 0 0 {name=V9 value=0.6}
...
C {devices/lab_pin.sym} 1100 -120 0 1 {name=l19 sig_type=std_logic lab=out}
C {sky130_stdcells/xor2_1.sym} 960 -120 0 0 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
...
C {devices/lab_pin.sym} 540 -120 1 0 {name=l17 sig_type=std_logic lab=clk}
...
C {devices/lab_pin.sym} 900 -140 1 1 {name=l22 sig_type=std_logic lab=o3}
C {devices/lab_pin.sym} 360 -100 1 0 {name=l25 sig_type=std_logic lab=clkbar}
C {sky130_stdcells/buf_1.sym} 1060 -120 0 0 {name=x6 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
...
C {sky130_stdcells/dfxtp_1.sym} 810 -130 0 0 {name=x10 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
C {devices/lab_pin.sym} 720 -140 1 0 {name=l29 sig_type=std_logic lab=clkbar}
