...
C {devices/opin.sym} 640 -70 0 0 {name=p2 lab=out}
...
C {sky130_stdcells/dfxtp_1.sym} 430 -120 0 0 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
C {devices/lab_pin.sym} 340 -130 0 0 {name=l1 sig_type=std_logic lab=clk}
C {sky130_stdcells/xor2_1.sym} 580 -70 0 0 {name=x3 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
