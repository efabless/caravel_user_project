...
C {sky130_stdcells/xor2_1.sym} 920 -120 2 1 {name=x4 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
...
C {sky130_stdcells/and2_0.sym} 1040 -210 2 1 {name=x13 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
