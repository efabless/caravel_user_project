...
N 450 -220 580 -220 { lab=bias}
N 540 -200 580 -200 { lab=bias}
N 540 -220 540 -200 { lab=bias}
N 540 -180 580 -180 { lab=fclk}
N 680 -300 790 -300 { lab=phi1}
N -110 -220 -110 -200 { lab=phi1b}
N 680 -280 710 -280 { lab=phi1b}
N 680 -260 830 -260 { lab=phi2}
N 680 -220 870 -220 { lab=cclk}
N 680 -200 700 -200 { lab=cclkb}
N 680 -180 700 -180 { lab=fclkdiv2}
N 680 -240 750 -240 { lab=phi2b}
N 70 -140 160 -140 { lab=thresh1}
N 70 -120 140 -120 { lab=thresh2}
N 140 -120 140 50 { lab=thresh2}
N 450 -350 580 -350 { lab=rstb}
N 160 -140 160 -40 { lab=thresh1}
N 580 -350 580 -300 { lab=rstb}
...
C {devices/vsource.sym} 540 -150 0 0 {name=Vfclk value="DC 0 PULSE (0 1.2 1n 1n 1n \{duty_cycle*1/f\} \{1/f\} 0"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} 540 -120 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} 790 -300 2 0 {name=l12 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} 830 -260 2 0 {name=l13 sig_type=std_logic lab=phi2}
C {clkgen/filter_clkgen.sym} 630 -240 0 0 {name=X2}
C {devices/vsource.sym} 450 -190 0 0 {name=Vbias value="DC 0.6"}
C {devices/gnd.sym} 450 -160 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 710 -280 2 0 {name=l4 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} 750 -240 2 0 {name=l9 sig_type=std_logic lab=phi2b}
...
C {devices/lab_pin.sym} 450 -350 0 0 {name=l17 sig_type=std_logic lab=rstb}
C {devices/vsource.sym} 450 -320 0 0 {name=Vrstb value="DC 0 PWL (0 0 \{1/4*1/f\} 0  \{1/4*1/f +0.1u\} 1.2\}"}
C {devices/gnd.sym} 450 -290 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} 540 -180 0 0 {name=l2 sig_type=std_logic lab=fclk}
...
C {devices/lab_pin.sym} 450 -220 0 0 {name=l21 sig_type=std_logic lab=bias}
C {devices/lab_pin.sym} 700 -200 2 0 {name=l22 sig_type=std_logic lab=cclkb}
C {devices/lab_pin.sym} 700 -180 2 0 {name=l23 sig_type=std_logic lab=fclkdiv2}
C {devices/lab_pin.sym} 870 -220 2 0 {name=l24 sig_type=std_logic lab=cclk}
...
C {Switched_Caps/16switchcaps_2phi_thresh.sym} -90 210 0 0 {name=X5 W=4 L=4}
C {Switched_Caps/16switchcaps_2phi_thresh.sym} -90 -150 0 0 {name=X1 W=4 L=4}
