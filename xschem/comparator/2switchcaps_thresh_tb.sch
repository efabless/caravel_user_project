...
N 140 -540 270 -540 { lab=bias}
N 230 -520 270 -520 { lab=bias}
N 230 -540 230 -520 { lab=bias}
N 230 -500 270 -500 { lab=fclk}
N 370 -620 480 -620 { lab=phi1}
N -20 -240 -20 -220 { lab=phi1b}
N 370 -600 400 -600 { lab=phi1b}
N 370 -580 520 -580 { lab=phi2}
N 370 -540 560 -540 { lab=cclk}
N 370 -520 390 -520 { lab=cclkb}
N 370 -500 390 -500 { lab=fclkdiv2}
N 370 -560 440 -560 { lab=phi2b}
N 70 -140 160 -140 { lab=thresh1}
N 70 -120 140 -120 { lab=thresh2}
N 140 -120 140 50 { lab=thresh2}
N 140 -670 270 -670 { lab=rstb}
N 160 -140 160 -40 { lab=thresh1}
N 270 -670 270 -620 { lab=rstb}
...
N -1220 -160 -1050 -160 { lab=inp}
N -1220 200 -1050 200 { lab=inm}
N -540 -240 -540 -220 { lab=phi2b}
N -580 -240 -580 -220 { lab=phi1b}
N -540 -80 -540 -60 { lab=phi2}
N -580 -80 -580 -60 { lab=phi1}
N -680 -240 -680 -220 { lab=phi2b}
N -720 -240 -720 -220 { lab=phi1b}
N -680 -80 -680 -60 { lab=phi2}
N -720 -80 -720 -60 { lab=phi1}
N -820 -240 -820 -220 { lab=phi2b}
N -860 -240 -860 -220 { lab=phi1b}
N -820 -80 -820 -60 { lab=phi2}
N -860 -80 -860 -60 { lab=phi1}
N -540 120 -540 140 { lab=phi2b}
N -580 120 -580 140 { lab=phi1b}
N -540 280 -540 300 { lab=phi2}
N -580 280 -580 300 { lab=phi1}
N -680 120 -680 140 { lab=phi2b}
N -720 120 -720 140 { lab=phi1b}
N -680 280 -680 300 { lab=phi2}
N -720 280 -720 300 { lab=phi1}
N -820 120 -820 140 { lab=phi2b}
N -860 120 -860 140 { lab=phi1b}
N -820 280 -820 300 { lab=phi2}
N -860 280 -860 300 { lab=phi1}
N -960 -240 -960 -220 { lab=phi2b}
N -1000 -240 -1000 -220 { lab=phi1b}
N -960 -80 -960 -60 { lab=phi2}
N -1000 -80 -1000 -60 { lab=phi1}
N -960 120 -960 140 { lab=phi2b}
N -1000 120 -1000 140 { lab=phi1b}
N -960 280 -960 300 { lab=phi2}
N -1000 280 -1000 300 { lab=phi1}
C {devices/netlist.sym} -670 -670 0 0 {name=SPICE only_toplevel=false value="
...
.save all
"}
C {devices/vsource.sym} -1220 -130 0 0 {name=Vinp value="DC 0 SIN(0 0.1 15k)"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} -1220 -40 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 280 -160 2 0 {name=l1 sig_type=std_logic lab=outp}
C {devices/lab_pin.sym} -1220 -160 0 0 {name=l5 sig_type=std_logic lab=inp}
...
C {devices/vsource.sym} 230 -470 0 0 {name=Vfclk value="DC 0 PULSE (0 1.2 1n 1n 1n \{duty_cycle*1/f\} \{1/f\} 0"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} 230 -440 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} 480 -620 2 0 {name=l12 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} 520 -580 2 0 {name=l13 sig_type=std_logic lab=phi2}
C {clkgen/filter_clkgen.sym} 320 -560 0 0 {name=X2}
C {devices/vsource.sym} 140 -510 0 0 {name=Vbias value="DC 0.6"}
C {devices/gnd.sym} 140 -480 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 400 -600 2 0 {name=l4 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} 440 -560 2 0 {name=l9 sig_type=std_logic lab=phi2b}
...
C {devices/lab_pin.sym} 140 -670 0 0 {name=l17 sig_type=std_logic lab=rstb}
C {devices/vsource.sym} 140 -640 0 0 {name=Vrstb value="DC 0 PWL (0 0 \{1/4*1/f\} 0  \{1/4*1/f +0.1u\} 1.2\}"}
C {devices/gnd.sym} 140 -610 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} 230 -500 0 0 {name=l2 sig_type=std_logic lab=fclk}
...
C {devices/lab_pin.sym} 140 -540 0 0 {name=l21 sig_type=std_logic lab=bias}
C {devices/lab_pin.sym} 390 -520 2 0 {name=l22 sig_type=std_logic lab=cclkb}
C {devices/lab_pin.sym} 390 -500 2 0 {name=l23 sig_type=std_logic lab=fclkdiv2}
C {devices/lab_pin.sym} 560 -540 2 0 {name=l24 sig_type=std_logic lab=cclk}
...
C {devices/vsource.sym} -1220 230 0 0 {name=Vinm value="DC 0 SIN(0 -0.1 15k)"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} -1220 320 0 0 {name=l28 lab=GND}
C {devices/lab_pin.sym} 280 200 2 0 {name=l29 sig_type=std_logic lab=outm}
C {devices/lab_pin.sym} -1220 200 0 0 {name=l30 sig_type=std_logic lab=inm}
...
C {devices/vsource.sym} -1220 -70 0 0 {name=Vinp1 value="DC 0 SIN(0.7 0.1 12k)"
*SIN (0.6 0.6 1k)"}
C {devices/vsource.sym} -1220 290 0 0 {name=Vinm1 value="DC 0 SIN(0.5 -0.1 12k)"
*SIN (0.6 0.6 1k)"}
...
C {Switched_Caps/2switchcaps_thresh.sym} 0 -160 0 0 {name=X1 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps_thresh.sym} 0 200 0 0 {name=X3 Wcap=5 Lcap=20}
C {Switched_Caps/2switchcaps.sym} -140 -160 0 0 {name=X5 Wcap=5 Lcap=20}
C {Switched_Caps/2switchcaps.sym} -140 200 0 0 {name=X6 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps.sym} -280 -160 0 0 {name=X7 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps.sym} -420 -160 0 0 {name=X8 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps.sym} -280 200 0 0 {name=X9 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps.sym} -420 200 0 0 {name=X10 Wcap=5 Lcap=20}
...
C {Switched_Caps/2switchcaps.sym} -560 -160 0 0 {name=X11 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -580 -240 1 0 {name=l72 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -540 -240 1 0 {name=l73 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -580 -60 3 0 {name=l74 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -540 -60 3 0 {name=l75 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -700 -160 0 0 {name=X12 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -720 -240 1 0 {name=l76 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -680 -240 1 0 {name=l77 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -720 -60 3 0 {name=l78 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -680 -60 3 0 {name=l79 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -840 -160 0 0 {name=X13 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -860 -240 1 0 {name=l80 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -820 -240 1 0 {name=l81 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -860 -60 3 0 {name=l82 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -820 -60 3 0 {name=l83 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -560 200 0 0 {name=X14 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -580 120 1 0 {name=l84 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -540 120 1 0 {name=l85 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -580 300 3 0 {name=l86 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -540 300 3 0 {name=l87 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -700 200 0 0 {name=X15 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -720 120 1 0 {name=l88 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -680 120 1 0 {name=l89 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -720 300 3 0 {name=l90 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -680 300 3 0 {name=l91 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -840 200 0 0 {name=X16 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -860 120 1 0 {name=l92 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -820 120 1 0 {name=l93 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -860 300 3 0 {name=l94 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -820 300 3 0 {name=l95 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -980 -160 0 0 {name=X17 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -1000 -240 1 0 {name=l96 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -960 -240 1 0 {name=l97 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -1000 -60 3 0 {name=l98 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -960 -60 3 0 {name=l99 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps.sym} -980 200 0 0 {name=X18 Wcap=5 Lcap=20}
C {devices/lab_pin.sym} -1000 120 1 0 {name=l100 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -960 120 1 0 {name=l101 sig_type=std_logic lab=phi2b}
C {devices/lab_pin.sym} -1000 300 3 0 {name=l102 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} -960 300 3 0 {name=l103 sig_type=std_logic lab=phi2}
