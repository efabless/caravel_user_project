...
T {need wired OR's} 290 -300 0 0 0.2 0.2 {}
T {need JK ff} 130 -100 0 0 0.2 0.2 {}
...
C {devices/iopin.sym} -60 -260 3 0 {name=p14 lab=CLR}
C {devices/iopin.sym} 270 -260 3 0 {name=p15 lab=ACT}
...
C {sky130_stdcells/dfrtp_1.sym} 180 -140 0 0 {name=x5 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_lp__ }
C {sky130_stdcells/inv_1.sym} -440 -400 0 0 {name=x9 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_lp__ }
C {devices/lab_pin.sym} -480 -400 0 0 {name=l1 sig_type=std_logic lab=phi2}
