...
C {devices/vsource.sym} -340 60 0 0 {name=Vfclk value="DC 0 PULSE (0 1.2 1p 1p 1p \{fclk_dc*1/fclk\} \{1/fclk\} 0"
*SIN (0.6 0.6 1k)"}
...
C {clkgen/comp_clks.sym} 0 0 0 0 {name=X1 Wpmos=1.26 Lpmos=0.18 Wnmos=0.42 Lnmos=0.18}
