...
N -170 50 -120 50 { lab=clk}
C {transmission_gate/transmission_gate.sym} -70 50 0 0 {name=X3}
C {inv/inv.sym} -70 -50 0 0 {name=X1}
C {inv/inv.sym} 70 50 0 0 {name=X4}
C {inv/inv.sym} 70 -50 0 0 {name=X2}
