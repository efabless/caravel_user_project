...
N 200 80 200 260 { lab=c2b}
N -200 180 -110 180 { lab=cclk}
N -200 280 -140 280 { lab=thresh2}
...
N -80 260 200 260 { lab=c2b}
N -110 180 -110 210 { lab=cclk}
...
C {devices/ipin.sym} -200 180 0 0 {name=p8 lab=cclk}
C {devices/lab_pin.sym} 200 260 2 0 {name=l3 sig_type=std_logic lab=c2b}
C {mux/mux2-1.sym} -110 260 2 1 {name=X3}
C {devices/ipin.sym} -200 280 0 0 {name=p9 lab=thresh2}
