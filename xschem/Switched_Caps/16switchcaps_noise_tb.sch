...
S {}
E {}
T {http://ngspice.sourceforge.net/docs/ngspice-html-manual/manual.xhtml#magicparlabel-4894} -580 300 0 0 0.2 0.2 {}
N -160 0 -130 0 { lab=in}
N 150 0 180 0 { lab=out}
N -340 120 -300 120 { lab=in}
N -20 250 20 250 { lab=phi_clk}
N -20 50 -20 250 { lab=phi_clk}
N 20 50 20 110 { lab=phi_clkb}
N 20 210 20 250 { lab=phi_clk}
C {devices/netlist.sym} -240 -390 0 0 {name=SPICE only_toplevel=false value="
...
.save all
"}
C {devices/vsource.sym} -340 150 0 0 {name=Vin value="DC 0 TRRANDOM (1 \{1/f/10\} 0 0.6 0.6)"
...
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} -340 180 0 0 {name=l3 lab=GND}
...
C {devices/lab_pin.sym} -300 120 2 0 {name=l5 sig_type=std_logic lab=in}
