...
N -360 380 -230 380 { lab=bias}
N -270 400 -230 400 { lab=bias}
N -270 380 -270 400 { lab=bias}
...
C {devices/vsource.sym} -360 410 0 0 {name=Vbias value="DC 0.6"}
C {devices/gnd.sym} -360 440 0 0 {name=l8 lab=GND}
...
C {devices/lab_pin.sym} -360 380 0 0 {name=l21 sig_type=std_logic lab=bias}
