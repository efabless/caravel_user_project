...
.save all
"}
C {devices/vsource.sym} -340 230 0 0 {name=Vin value="DC 0 PULSE (0 \{1u * f/1000000\} 1n 1n 1n \{2*duty_cycle*1/f\} \{tend\}"
*SIN (0.6 0.6 1k)"}
...
C {Switched_Caps/16switchcaps.sym} 0 0 0 0 {name=X1 W=10 L=5}
