...
N -360 480 -230 480 { lab=bias}
N -270 500 -230 500 { lab=bias}
N -270 480 -270 500 { lab=bias}
N -270 520 -230 520 { lab=fclk}
N -130 400 -20 400 { lab=phi1}
N -20 -240 -20 -220 { lab=phi1b}
N -130 420 -100 420 { lab=phi1b}
N -130 440 20 440 { lab=phi2}
N -130 480 60 480 { lab=cclk}
N -130 500 -110 500 { lab=cclkb}
N -130 520 -110 520 { lab=fclkdiv2}
N -130 460 -60 460 { lab=phi2b}
N 70 -140 160 -140 { lab=thresh1}
N 70 -120 140 -120 { lab=thresh2}
N 140 -120 140 50 { lab=thresh2}
N -360 350 -230 350 { lab=rstb}
N 160 -140 160 -40 { lab=thresh1}
N -230 350 -230 400 { lab=rstb}
...
.tran \{1/f/100\} \{2*256*1/f\}
.save all
"}
C {devices/vsource.sym} -360 -130 0 0 {name=Vinp value="DC 0.6 SIN(0.8 0.4 10k)"
*SIN (0.6 0.6 1k)"}
...
C {devices/vsource.sym} -360 -270 0 0 {name=VDD value="DC 1.2"}
C {devices/gnd.sym} -360 -240 0 0 {name=l6 lab=GND}
C {devices/vdd.sym} -360 -300 0 0 {name=l7 lab=VDD}
C {devices/vsource.sym} -270 550 0 0 {name=Vfclk value="DC 0 PULSE (0 1.2 1n 1n 1n \{duty_cycle*1/f\} \{1/f\} 0"
*SIN (0.6 0.6 1k)"}
C {devices/gnd.sym} -270 580 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} -20 400 2 0 {name=l12 sig_type=std_logic lab=phi1}
C {devices/lab_pin.sym} 20 440 2 0 {name=l13 sig_type=std_logic lab=phi2}
C {Switched_Caps/2switchcaps_thresh.sym} 0 -160 0 0 {name=X1 Wcap=10 Lcap=5}
C {clkgen/filter_clkgen.sym} -180 460 0 0 {name=X2}
C {devices/vsource.sym} -360 510 0 0 {name=Vbias value="DC 0.6"}
C {devices/gnd.sym} -360 540 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} -100 420 2 0 {name=l4 sig_type=std_logic lab=phi1b}
C {devices/lab_pin.sym} -60 460 2 0 {name=l9 sig_type=std_logic lab=phi2b}
...
C {devices/lab_pin.sym} -360 350 0 0 {name=l17 sig_type=std_logic lab=rstb}
C {devices/vsource.sym} -360 380 0 0 {name=Vrstb value="DC 0 PWL (0 0 \{1/4*1/f\} 0  \{1/4*1/f +0.1u\} 1.2\}"}
C {devices/gnd.sym} -360 410 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} -270 520 0 0 {name=l2 sig_type=std_logic lab=fclk}
...
C {devices/lab_pin.sym} -360 480 0 0 {name=l21 sig_type=std_logic lab=bias}
C {devices/lab_pin.sym} -110 500 2 0 {name=l22 sig_type=std_logic lab=cclkb}
C {devices/lab_pin.sym} -110 520 2 0 {name=l23 sig_type=std_logic lab=fclkdiv2}
C {devices/lab_pin.sym} 60 480 2 0 {name=l24 sig_type=std_logic lab=cclk}
...
C {devices/vsource.sym} -360 230 0 0 {name=Vinm value="DC 0.6 SIN(0.4 -0.4 10k)"
*SIN (0.6 0.6 1k)"}
