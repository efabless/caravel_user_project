...
To update ``precheck`` to the new release

    .. code:: bash

       MPW_TAG=<new_tag> make precheck
...
.. code:: bash
   ...
   curl -k https://raw.githubusercontent.com/efabless/caravel_user_project/gf180mcu/Makefile > Makefile
