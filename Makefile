...
ifeq ($(PDK),sky130A)
	...
	export OPEN_PDKS_COMMIT?=3df14f84ab167baf757134739bb1d2c5c044849c
...
.PHONY: setup
setup: check_dependencies install check-env install_mcw openlane pdk-with-volare setup-timing-scripts
