...
if { $::env(IO_SYNC) } {
    ...
    set_input_delay -min [expr $in_ext_delay + 1.9]  -clock [get_clocks {clk}] -add_delay [get_ports {io_in[5]}]
    set_input_delay -min [expr $in_ext_delay + 1.94] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[23]}]
    set_input_delay -min [expr $in_ext_delay + 1.91] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[8]}]
    set_input_delay -min [expr $in_ext_delay + 1.89] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[16]}]
    set_input_delay -min [expr $in_ext_delay + 1.87] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[2]}]
    set_input_delay -min [expr $in_ext_delay + 1.86] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[4]}]
    set_input_delay -min [expr $in_ext_delay + 1.86] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[3]}]
    set_input_delay -min [expr $in_ext_delay + 1.82] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[33]}]
    set_input_delay -min [expr $in_ext_delay + 1.82] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[1]}]
    set_input_delay -min [expr $in_ext_delay + 1.78] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[24]}]
    set_input_delay -min [expr $in_ext_delay + 1.78] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[0]}]
    set_input_delay -min [expr $in_ext_delay + 1.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[6]}]
    set_input_delay -min [expr $in_ext_delay + 1.76] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[32]}]
    set_input_delay -min [expr $in_ext_delay + 1.76] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[19]}]
    set_input_delay -min [expr $in_ext_delay + 1.75] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[36]}]
    set_input_delay -min [expr $in_ext_delay + 1.75] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[26]}]
    set_input_delay -min [expr $in_ext_delay + 1.74] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[34]}]
    set_input_delay -min [expr $in_ext_delay + 1.73] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[37]}]
    set_input_delay -min [expr $in_ext_delay + 1.73] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[25]}]
    set_input_delay -min [expr $in_ext_delay + 1.72] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[27]}]
    set_input_delay -min [expr $in_ext_delay + 1.72] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[22]}]
    set_input_delay -min [expr $in_ext_delay + 1.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[7]}]
    set_input_delay -min [expr $in_ext_delay + 1.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[30]}]
    set_input_delay -min [expr $in_ext_delay + 1.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[29]}]
    set_input_delay -min [expr $in_ext_delay + 1.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[28]}]
    set_input_delay -min [expr $in_ext_delay + 1.69] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[35]}]
    set_input_delay -min [expr $in_ext_delay + 1.69] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[31]}]
    set_input_delay -min [expr $in_ext_delay + 1.68] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[9]}]
    set_input_delay -min [expr $in_ext_delay + 1.68] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[12]}]
    set_input_delay -min [expr $in_ext_delay + 1.68] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[11]}]
    set_input_delay -min [expr $in_ext_delay + 1.68] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[10]}]
    set_input_delay -min [expr $in_ext_delay + 1.67] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[15]}]
    set_input_delay -min [expr $in_ext_delay + 1.65] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[21]}]
    set_input_delay -min [expr $in_ext_delay + 1.65] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[20]}]
    set_input_delay -min [expr $in_ext_delay + 1.65] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[14]}]
    set_input_delay -min [expr $in_ext_delay + 1.63] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[18]}]
    set_input_delay -min [expr $in_ext_delay + 1.62] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[17]}]
    set_input_delay -min [expr $in_ext_delay + 1.58] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[13]}]
    set_input_delay -max [expr $in_ext_delay + 4.16] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[5]}]
    set_input_delay -max [expr $in_ext_delay + 4.13] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[2]}]
    set_input_delay -max [expr $in_ext_delay + 4.08] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[33]}]
    set_input_delay -max [expr $in_ext_delay + 4.08] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[1]}]
    set_input_delay -max [expr $in_ext_delay + 4.04] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[0]}]
    set_input_delay -max [expr $in_ext_delay + 4.02] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[6]}]
    set_input_delay -max [expr $in_ext_delay + 4.01] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[32]}]
    set_input_delay -max [expr $in_ext_delay + 4.01] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[23]}]
    set_input_delay -max [expr $in_ext_delay + 3.97] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[16]}]
    set_input_delay -max [expr $in_ext_delay + 3.95] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[8]}]
    set_input_delay -max [expr $in_ext_delay + 3.93] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[3]}]
    set_input_delay -max [expr $in_ext_delay + 3.8]  -clock [get_clocks {clk}] -add_delay [get_ports {io_in[22]}]
    set_input_delay -max [expr $in_ext_delay + 3.87] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[24]}]
    set_input_delay -max [expr $in_ext_delay + 3.86] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[4]}]
    set_input_delay -max [expr $in_ext_delay + 3.7]  -clock [get_clocks {clk}] -add_delay [get_ports {io_in[35]}]
    set_input_delay -max [expr $in_ext_delay + 3.7]  -clock [get_clocks {clk}] -add_delay [get_ports {io_in[12]}]
    set_input_delay -max [expr $in_ext_delay + 3.7]  -clock [get_clocks {clk}] -add_delay [get_ports {io_in[11]}]
    set_input_delay -max [expr $in_ext_delay + 3.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[7]}]
    set_input_delay -max [expr $in_ext_delay + 3.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[37]}]
    set_input_delay -max [expr $in_ext_delay + 3.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[36]}]
    set_input_delay -max [expr $in_ext_delay + 3.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[26]}]
    set_input_delay -max [expr $in_ext_delay + 3.77] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[19]}]
    set_input_delay -max [expr $in_ext_delay + 3.76] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[34]}]
    set_input_delay -max [expr $in_ext_delay + 3.76] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[25]}]
    set_input_delay -max [expr $in_ext_delay + 3.75] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[30]}]
    set_input_delay -max [expr $in_ext_delay + 3.75] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[27]}]
    set_input_delay -max [expr $in_ext_delay + 3.74] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[28]}]
    set_input_delay -max [expr $in_ext_delay + 3.74] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[21]}]
    set_input_delay -max [expr $in_ext_delay + 3.73] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[9]}]
    set_input_delay -max [expr $in_ext_delay + 3.73] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[29]}]
    set_input_delay -max [expr $in_ext_delay + 3.73] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[14]}]
    set_input_delay -max [expr $in_ext_delay + 3.72] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[17]}]
    set_input_delay -max [expr $in_ext_delay + 3.72] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[15]}]
    set_input_delay -max [expr $in_ext_delay + 3.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[31]}]
    set_input_delay -max [expr $in_ext_delay + 3.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[18]}]
    set_input_delay -max [expr $in_ext_delay + 3.71] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[10]}]
    set_input_delay -max [expr $in_ext_delay + 3.68] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[20]}]
    set_input_delay -max [expr $in_ext_delay + 3.64] -clock [get_clocks {clk}] -add_delay [get_ports {io_in[13]}]
}
...
set_input_transition -min 0.21  [get_ports {io_in[33]}]
set_input_transition -min 0.21  [get_ports {io_in[26]}]
...
set_input_transition -min 0.19  [get_ports {io_in[35]}]
set_input_transition -min 0.19  [get_ports {io_in[29]}]
...
set_input_transition -min 0.17  [get_ports {io_in[36]}]
set_input_transition -min 0.17  [get_ports {io_in[27]}]
...
set_input_transition -min 0.16  [get_ports {io_in[37]}]
set_input_transition -min 0.16  [get_ports {io_in[28]}]
...
set_input_transition -min 0.15  [get_ports {io_in[30]}]
set_input_transition -min 0.15  [get_ports {io_in[22]}]
...
set_input_transition -min 0.14  [get_ports {io_in[12]}]
...
set_input_transition -min 0.13  [get_ports {io_in[31]}]
set_input_transition -min 0.13  [get_ports {io_in[11]}]
...
set_input_transition -min 0.12  [get_ports {io_in[9]}]
set_input_transition -min 0.12  [get_ports {io_in[8]}]
set_input_transition -min 0.12  [get_ports {io_in[24]}]
set_input_transition -min 0.12  [get_ports {io_in[14]}]
set_input_transition -min 0.12  [get_ports {io_in[10]}]
...
set_input_transition -min 0.11  [get_ports {io_in[19]}]
...
set_input_transition -min 0.1   [get_ports {io_in[20]}]
set_input_transition -min 0.1   [get_ports {io_in[16]}]
set_input_transition -min 0.1   [get_ports {io_in[15]}]
set_input_transition -min 0.1   [get_ports {io_in[13]}]
...
set_input_transition -min 0.09  [get_ports {io_in[23]}]
...
set_input_transition -min 0.08  [get_ports {io_in[18]}]
...
set_input_transition -min 0.07  [get_ports {io_in[17]}]
...
set_input_transition -max 0.28  [get_ports {io_in[32]}]
...
set_input_transition -max 0.21  [get_ports {io_in[33]}]
...
set_input_transition -max 0.11  [get_ports {io_in[34]}]
set_input_transition -max 0.11  [get_ports {io_in[26]}]
...
set_input_transition -max 0.1   [get_ports {io_in[29]}]
set_input_transition -max 0.1   [get_ports {io_in[25]}]
...
set_input_transition -max 0.09  [get_ports {io_in[37]}]
set_input_transition -max 0.09  [get_ports {io_in[36]}]
set_input_transition -max 0.09  [get_ports {io_in[28]}]
set_input_transition -max 0.09  [get_ports {io_in[27]}]
set_input_transition -max 0.09  [get_ports {io_in[22]}]
...
set_input_transition -max 0.08  [get_ports {io_in[30]}]
set_input_transition -max 0.08  [get_ports {io_in[24]}]
set_input_transition -max 0.08  [get_ports {io_in[14]}]
set_input_transition -max 0.08  [get_ports {io_in[12]}]
set_input_transition -max 0.07  [get_ports {la_oenb[43]}]
set_input_transition -max 0.07  [get_ports {io_in[9]}]
set_input_transition -max 0.07  [get_ports {io_in[8]}]
set_input_transition -max 0.07  [get_ports {io_in[31]}]
set_input_transition -max 0.07  [get_ports {io_in[21]}]
set_input_transition -max 0.07  [get_ports {io_in[16]}]
set_input_transition -max 0.07  [get_ports {io_in[15]}]
set_input_transition -max 0.07  [get_ports {io_in[11]}]
set_input_transition -max 0.07  [get_ports {io_in[10]}]
set_input_transition -max 0.06  [get_ports {la_oenb[35]}]
set_input_transition -max 0.06  [get_ports {la_oenb[26]}]
set_input_transition -max 0.06  [get_ports {io_in[23]}]
set_input_transition -max 0.06  [get_ports {io_in[20]}]
set_input_transition -max 0.06  [get_ports {io_in[19]}]
set_input_transition -max 0.06  [get_ports {io_in[18]}]
set_input_transition -max 0.06  [get_ports {io_in[13]}]
set_input_transition -max 0.05  [get_ports {io_in[17]}]
...
set_output_delay -min 0.49 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[0]}]
...
set_output_delay -min 0.45 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[1]}]
...
set_output_delay -min 0.42 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[2]}]
...
set_output_delay -max 0.46 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[0]}]
...
set_output_delay -max 0.43 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[1]}]
...
set_output_delay -max 0.41 -clock [get_clocks {clk}] -add_delay [get_ports {user_irq[2]}]
...
if { $::env(IO_SYNC) } {
    ...
    set_output_delay -min [expr $out_ext_delay + 4.81]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[0]}]
    set_output_delay -min [expr $out_ext_delay + 4.72]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[1]}]
    set_output_delay -min [expr $out_ext_delay + 4.65]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[5]}]
    set_output_delay -min [expr $out_ext_delay + 4.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[4]}]
    set_output_delay -min [expr $out_ext_delay + 4.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[3]}]
    set_output_delay -min [expr $out_ext_delay + 4.62]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[32]}]
    set_output_delay -min [expr $out_ext_delay + 4.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[33]}]
    set_output_delay -min [expr $out_ext_delay + 4.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[2]}]
    set_output_delay -min [expr $out_ext_delay + 4.57]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[6]}]
    set_output_delay -min [expr $out_ext_delay + 4.56]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[35]}]
    set_output_delay -min [expr $out_ext_delay + 4.4] -clock [get_clocks {clk}] -add_delay [get_ports {io_out[28]}]
    set_output_delay -min [expr $out_ext_delay + 4.4] -clock [get_clocks {clk}] -add_delay [get_ports {io_out[24]}]
    set_output_delay -min [expr $out_ext_delay + 4.4] -clock [get_clocks {clk}] -add_delay [get_ports {io_out[14]}]
    set_output_delay -min [expr $out_ext_delay + 4.49]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[20]}]
    set_output_delay -min [expr $out_ext_delay + 4.48]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[34]}]
    set_output_delay -min [expr $out_ext_delay + 4.48]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[19]}]
    set_output_delay -min [expr $out_ext_delay + 4.46]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[37]}]
    set_output_delay -min [expr $out_ext_delay + 4.46]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[26]}]
    set_output_delay -min [expr $out_ext_delay + 4.45]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[25]}]
    set_output_delay -min [expr $out_ext_delay + 4.44]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[36]}]
    set_output_delay -min [expr $out_ext_delay + 4.41]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[27]}]
    set_output_delay -min [expr $out_ext_delay + 4.41]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[21]}]
    set_output_delay -min [expr $out_ext_delay + 4.39]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[29]}]
    set_output_delay -min [expr $out_ext_delay + 4.39]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[22]}]
    set_output_delay -min [expr $out_ext_delay + 4.39]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[18]}]
    set_output_delay -min [expr $out_ext_delay + 4.38]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[16]}]
    set_output_delay -min [expr $out_ext_delay + 4.37]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[9]}]
    set_output_delay -min [expr $out_ext_delay + 4.37]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[17]}]
    set_output_delay -min [expr $out_ext_delay + 4.36]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[7]}]
    set_output_delay -min [expr $out_ext_delay + 4.36]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[12]}]
    set_output_delay -min [expr $out_ext_delay + 4.35]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[30]}]
    set_output_delay -min [expr $out_ext_delay + 4.35]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[23]}]
    set_output_delay -min [expr $out_ext_delay + 4.35]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[15]}]
    set_output_delay -min [expr $out_ext_delay + 4.34]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[31]}]
    set_output_delay -min [expr $out_ext_delay + 4.33]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[8]}]
    set_output_delay -min [expr $out_ext_delay + 4.33]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[13]}]
    set_output_delay -min [expr $out_ext_delay + 4.32]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[11]}]
    set_output_delay -min [expr $out_ext_delay + 4.32]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[10]}]
    set_output_delay -min [expr $out_ext_delay + 3.23]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[0]}]
    set_output_delay -min [expr $out_ext_delay + 3.21]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[1]}]
    set_output_delay -min [expr $out_ext_delay + 3.08]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[3]}]
    set_output_delay -min [expr $out_ext_delay + 3.08]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[2]}]
    set_output_delay -min [expr $out_ext_delay + 3.05]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[5]}]
    set_output_delay -min [expr $out_ext_delay + 3.04]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[6]}]
    set_output_delay -min [expr $out_ext_delay + 3.04]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[4]}]
    set_output_delay -min [expr $out_ext_delay + 2.9] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[20]}]
    set_output_delay -min [expr $out_ext_delay + 2.92]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[32]}]
    set_output_delay -min [expr $out_ext_delay + 2.8] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[14]}]
    set_output_delay -min [expr $out_ext_delay + 2.8] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[10]}]
    set_output_delay -min [expr $out_ext_delay + 2.89]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[19]}]
    set_output_delay -min [expr $out_ext_delay + 2.88]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[34]}]
    set_output_delay -min [expr $out_ext_delay + 2.88]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[33]}]
    set_output_delay -min [expr $out_ext_delay + 2.88]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[25]}]
    set_output_delay -min [expr $out_ext_delay + 2.87]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[35]}]
    set_output_delay -min [expr $out_ext_delay + 2.87]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[27]}]
    set_output_delay -min [expr $out_ext_delay + 2.85]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[36]}]
    set_output_delay -min [expr $out_ext_delay + 2.85]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[24]}]
    set_output_delay -min [expr $out_ext_delay + 2.84]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[28]}]
    set_output_delay -min [expr $out_ext_delay + 2.84]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[21]}]
    set_output_delay -min [expr $out_ext_delay + 2.84]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[18]}]
    set_output_delay -min [expr $out_ext_delay + 2.84]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[12]}]
    set_output_delay -min [expr $out_ext_delay + 2.83]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[37]}]
    set_output_delay -min [expr $out_ext_delay + 2.83]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[26]}]
    set_output_delay -min [expr $out_ext_delay + 2.83]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[22]}]
    set_output_delay -min [expr $out_ext_delay + 2.83]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[15]}]
    set_output_delay -min [expr $out_ext_delay + 2.82]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[29]}]
    set_output_delay -min [expr $out_ext_delay + 2.82]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[11]}]
    set_output_delay -min [expr $out_ext_delay + 2.81]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[23]}]
    set_output_delay -min [expr $out_ext_delay + 2.81]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[16]}]
    set_output_delay -min [expr $out_ext_delay + 2.79]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[30]}]
    set_output_delay -min [expr $out_ext_delay + 2.78]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[17]}]
    set_output_delay -min [expr $out_ext_delay + 2.77]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[9]}]
    set_output_delay -min [expr $out_ext_delay + 2.77]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[8]}]
    set_output_delay -min [expr $out_ext_delay + 2.76]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[31]}]
    set_output_delay -min [expr $out_ext_delay + 2.75]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[7]}]
    set_output_delay -min [expr $out_ext_delay + 2.74]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[13]}]
    set_output_delay -max [expr $out_ext_delay + 9.06]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[1]}]
    set_output_delay -max [expr $out_ext_delay + 9.03]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[0]}]
    set_output_delay -max [expr $out_ext_delay + 8.9] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[3]}]
    set_output_delay -max [expr $out_ext_delay + 8.9] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[2]}]
    set_output_delay -max [expr $out_ext_delay + 8.87]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[5]}]
    set_output_delay -max [expr $out_ext_delay + 8.86]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[4]}]
    set_output_delay -max [expr $out_ext_delay + 8.85]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[0]}]
    set_output_delay -max [expr $out_ext_delay + 8.84]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[6]}]
    set_output_delay -max [expr $out_ext_delay + 8.82]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[1]}]
    set_output_delay -max [expr $out_ext_delay + 8.7] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[35]}]
    set_output_delay -max [expr $out_ext_delay + 8.71]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[32]}]
    set_output_delay -max [expr $out_ext_delay + 8.6] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[8]}]
    set_output_delay -max [expr $out_ext_delay + 8.6] -clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[31]}]
    set_output_delay -max [expr $out_ext_delay + 8.69]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[6]}]
    set_output_delay -max [expr $out_ext_delay + 8.69]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[3]}]
    set_output_delay -max [expr $out_ext_delay + 8.69]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[32]}]
    set_output_delay -max [expr $out_ext_delay + 8.69]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[27]}]
    set_output_delay -max [expr $out_ext_delay + 8.68]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[5]}]
    set_output_delay -max [expr $out_ext_delay + 8.68]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[4]}]
    set_output_delay -max [expr $out_ext_delay + 8.68]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[33]}]
    set_output_delay -max [expr $out_ext_delay + 8.68]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[24]}]
    set_output_delay -max [expr $out_ext_delay + 8.67]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[34]}]
    set_output_delay -max [expr $out_ext_delay + 8.67]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[28]}]
    set_output_delay -max [expr $out_ext_delay + 8.67]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[20]}]
    set_output_delay -max [expr $out_ext_delay + 8.66]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[2]}]
    set_output_delay -max [expr $out_ext_delay + 8.66]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[33]}]
    set_output_delay -max [expr $out_ext_delay + 8.66]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[25]}]
    set_output_delay -max [expr $out_ext_delay + 8.66]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[19]}]
    set_output_delay -max [expr $out_ext_delay + 8.66]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[12]}]
    set_output_delay -max [expr $out_ext_delay + 8.65]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[29]}]
    set_output_delay -max [expr $out_ext_delay + 8.65]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[11]}]
    set_output_delay -max [expr $out_ext_delay + 8.64]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[36]}]
    set_output_delay -max [expr $out_ext_delay + 8.64]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[23]}]
    set_output_delay -max [expr $out_ext_delay + 8.64]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[16]}]
    set_output_delay -max [expr $out_ext_delay + 8.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[35]}]
    set_output_delay -max [expr $out_ext_delay + 8.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[37]}]
    set_output_delay -max [expr $out_ext_delay + 8.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[21]}]
    set_output_delay -max [expr $out_ext_delay + 8.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[14]}]
    set_output_delay -max [expr $out_ext_delay + 8.63]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[10]}]
    set_output_delay -max [expr $out_ext_delay + 8.62]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[30]}]
    set_output_delay -max [expr $out_ext_delay + 8.62]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[26]}]
    set_output_delay -max [expr $out_ext_delay + 8.62]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[18]}]
    set_output_delay -max [expr $out_ext_delay + 8.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[9]}]
    set_output_delay -max [expr $out_ext_delay + 8.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[22]}]
    set_output_delay -max [expr $out_ext_delay + 8.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[17]}]
    set_output_delay -max [expr $out_ext_delay + 8.61]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[15]}]
    set_output_delay -max [expr $out_ext_delay + 8.59]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[7]}]
    set_output_delay -max [expr $out_ext_delay + 8.58]-clock [get_clocks {clk}] -add_delay [get_ports {io_oeb[13]}]
    set_output_delay -max [expr $out_ext_delay + 8.53]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[26]}]
    set_output_delay -max [expr $out_ext_delay + 8.4] -clock [get_clocks {clk}] -add_delay [get_ports {io_out[11]}]
    set_output_delay -max [expr $out_ext_delay + 8.4] -clock [get_clocks {clk}] -add_delay [get_ports {io_out[10]}]
    set_output_delay -max [expr $out_ext_delay + 8.49]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[34]}]
    set_output_delay -max [expr $out_ext_delay + 8.49]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[27]}]
    set_output_delay -max [expr $out_ext_delay + 8.49]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[20]}]
    set_output_delay -max [expr $out_ext_delay + 8.49]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[19]}]
    set_output_delay -max [expr $out_ext_delay + 8.48]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[37]}]
    set_output_delay -max [expr $out_ext_delay + 8.48]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[25]}]
    set_output_delay -max [expr $out_ext_delay + 8.47]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[36]}]
    set_output_delay -max [expr $out_ext_delay + 8.47]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[29]}]
    set_output_delay -max [expr $out_ext_delay + 8.47]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[28]}]
    set_output_delay -max [expr $out_ext_delay + 8.45]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[9]}]
    set_output_delay -max [expr $out_ext_delay + 8.44]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[7]}]
    set_output_delay -max [expr $out_ext_delay + 8.44]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[17]}]
    set_output_delay -max [expr $out_ext_delay + 8.44]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[12]}]
    set_output_delay -max [expr $out_ext_delay + 8.43]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[24]}]
    set_output_delay -max [expr $out_ext_delay + 8.43]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[21]}]
    set_output_delay -max [expr $out_ext_delay + 8.43]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[14]}]
    set_output_delay -max [expr $out_ext_delay + 8.42]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[31]}]
    set_output_delay -max [expr $out_ext_delay + 8.42]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[30]}]
    set_output_delay -max [expr $out_ext_delay + 8.42]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[22]}]
    set_output_delay -max [expr $out_ext_delay + 8.42]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[18]}]
    set_output_delay -max [expr $out_ext_delay + 8.41]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[8]}]
    set_output_delay -max [expr $out_ext_delay + 8.41]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[16]}]
    set_output_delay -max [expr $out_ext_delay + 8.41]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[13]}]
    set_output_delay -max [expr $out_ext_delay + 8.39]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[23]}]
    set_output_delay -max [expr $out_ext_delay + 8.38]-clock [get_clocks {clk}] -add_delay [get_ports {io_out[15]}]
}
...
set_load 0.16  [get_ports {user_irq[0]}]
...
set_load 0.12  [get_ports {user_irq[2]}]
...
set_load 0.04  [get_ports {io_out[34]}]
set_load 0.04  [get_ports {io_out[33]}]
set_load 0.04  [get_ports {io_out[32]}]
...
set_load 0.04  [get_ports {io_oeb[37]}]
set_load 0.04  [get_ports {io_oeb[35]}]
set_load 0.04  [get_ports {io_oeb[32]}]
...
set_load 0.03  [get_ports {io_out[9]}]
set_load 0.03  [get_ports {io_out[5]}]
set_load 0.03  [get_ports {io_out[37]}]
set_load 0.03  [get_ports {io_out[36]}]
set_load 0.03  [get_ports {io_out[35]}]
set_load 0.03  [get_ports {io_out[30]}]
set_load 0.03  [get_ports {io_out[29]}]
set_load 0.03  [get_ports {io_out[28]}]
set_load 0.03  [get_ports {io_out[27]}]
set_load 0.03  [get_ports {io_out[26]}]
set_load 0.03  [get_ports {io_out[25]}]
set_load 0.03  [get_ports {io_out[1]}]
set_load 0.03  [get_ports {io_out[19]}]
set_load 0.03  [get_ports {io_oeb[6]}]
set_load 0.03  [get_ports {io_oeb[34]}]
set_load 0.03  [get_ports {io_oeb[33]}]
set_load 0.02  [get_ports {io_out[8]}]
set_load 0.02  [get_ports {io_out[7]}]
set_load 0.02  [get_ports {io_out[31]}]
set_load 0.02  [get_ports {io_out[21]}]
set_load 0.02  [get_ports {io_out[20]}]
set_load 0.02  [get_ports {io_out[14]}]
set_load 0.02  [get_ports {io_out[13]}]
...
set_load 0.01  [get_ports {io_oeb[31]}]
set_load 0.01  [get_ports {io_oeb[30]}]
set_load 0.01  [get_ports {io_oeb[22]}]
